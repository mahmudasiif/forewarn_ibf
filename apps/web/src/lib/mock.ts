...
export const MODELS: ModelSummary[] = [
  ...
  },
  {
    ...
    live: true,
    description:
      "IWFM's Jamuna basin flood model, web-enabled in the portal — inundation, hazard, risk and vulnerability maps plus per-area flood warnings from a forecast water level.",
  },
  {
    id: "cyclone-track",
  ...
  },
  {
    ...
    status: "healthy",
    lastRun: "—",
    runtime: "IWFM / BUET · LLM-assisted",
