...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        "flex w-full items-center justify-between gap-2 rounded-md border border-input bg-card px-3 py-2 text-sm text-foreground transition-colors",
        ...
        "*:data-[slot=select-value]:truncate *:data-[slot=select-value]:text-left",
        className,
      )}
      {...props}
    >
